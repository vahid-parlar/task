...
namespace API.Services
{
    public interface ITaskManagerService
    {
        ...
        Task<List<FilteredTaskResult>> GetFilteredTasks(TaskFilter dto);
    ...
    public class TaskManagerService : ITaskManagerService
    {
        ...
        public async Task<List<FilteredTaskResult>> GetFilteredTasks(TaskFilter dto)
        {
            var query = _db.ProjectTasks.Select(c=> new FilteredTaskResult
            {
                Id= c.Id,
                DeadLine= c.DeadLine,
